...
class Classifier2:
    ...
    def __init__(self): 
        ...
        # )
        self.model = pickle.load(open(CURRENT_DIR + "/classifier2/naive_bayes_2.pkl", "rb"))
        self.vectorizer_from_train_data = pickle.load(open(CURRENT_DIR + "/classifier2/count_vectorizer_2.pkl", "rb"))
