...
import { generateStakeholderChooseModel, getStakeholdersById } from "../../../redux/actions/stakeholderActions";
import { getApplicationdata } from "../../../redux/actions/applicationActions";
import StakeholderForm4 from "./form3";
const StakeholderForm3 = ({ application, toggleModal , applicationData }) => {
    const [model, setmodel] = useState();   
    const [generetedst, setgeneretedst] = useState([]);
    ...
    const handleSubmit = async e => {
        ...
        setActiveForm('form3');
        setIsLoading(true);
        getStakeholdersById(application.id)
        ...
        try {
            if (Tnote != ''){
                stakeholders = await generateStakeholderChooseModel(Tnote, model);
            }else{
                stakeholders = await generateStakeholderChooseModel(applicationdata1['transparency_note'], model);
            }
            setActiveForm('form4');
            
            console.log("stakeholders:", stakeholders);
            setgeneretedst(stakeholders)
        } catch (error) {
            // Handle errors here
            ...
            console.log("stakeholders after", stakeholders )
    ...
    return (
        ...
        <form className="form-modal" onSubmit={handleSubmit} >
                    ...
                    <div className="form-group">
                        ...
                        >
                            ...
                            <option value="ner_extraction">Spacy model</option>
                            <option value="t_ner_extraction">Transformer model</option>
                            <option value="x_ner_extraction">XLNET model</option>
                            <option value="b_ner_extraction">BERT model</option>
        ...
        {activeForm === 'form4' && <StakeholderForm4 stakeholders={generetedst} namelist1={namelist} toggleModal={toggleModal} />} {/* Display Form1 */}
        </div>
