...
import StakeholderInformationElementRelationshipchangeForm from "../../forms/StakeholderInformationElementRelationshipchangeForm/StakeholderInformationElementRelationshipchangeForm"
import StakeholderForm2 from "./form1";
const Home = ({
    application,
    stakeholder,
    informationElement,
    ...
    const renderForm = () => {
        switch (type) {
            ...
            case "stakeholder-information-element-relationship2":
                return <StakeholderInformationElementRelationshipchangeForm />;
            case "menu":
                return <ModalMenu />;
            default:
                break;
                                    ...
                                    <>
                                        {stakeholder.stakeholders.map(s => (
                                            <Card
                                                ...
                                                data-tip="This is a small description."
                                            />
                                        ))}
                                    </>
                                )}
